...
class SPSCustomScanLogic(LogicBase):

    """
        sps_customscanlogic:
        module.Class: 'local.sps_custom_scan_logic.SPSCustomScanLogic'
    """
    # connector
    ...
    dp832logic = Connector(interface = "DP832Logic", optional=True)
    ...
    def on_activate(self):
        ...
        self._dp832logic = self.dp832logic()
        self._sm_modenum = 0
        self._pr_modenum = 1
        self._eit_modenum = 2
        self._ss_modenum = 3
    ...
    def start_scanner_handler(self, current): 
        ...
        func_map = {
            ...
            self.CustomScanMode[6]: self.dp832_start_scanner,
        }
    ...
    def process_scanner_handler(self, current, scan_counter): 
        ...
        func_map = {
            ...
            self.CustomScanMode[6]: self.dp832_process_scanner,
        }
        func = func_map.get(value)
        func(scan_counter)
    ...
    def stop_scanner_handler(self, current): 
        ...
        func_map = {
            ...
            self.CustomScanMode[6]: self.dp832_stop_scanner,
        }
        func = func_map.get(value)
        func()
    ...
    def function_0_handler(self, current): 
        ...
        func_map = {
            ...
            self.CustomScanMode[6]: self.dp832_stop_scanner_0,
        }
        func = func_map.get(value)
        func()
