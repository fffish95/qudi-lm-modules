...
class ConfocalGui(GUIBase):
    ...
    slider_small_step = StatusVar(default=1e-5)    # initial value in meter
    slider_big_step = StatusVar(default=1e-4)     # initial value in meter
    ...
    def initMainUI(self):
        ...
        *.ui file and configures the event handling between the modules.
        ...
        self._mw.depth_refocus_ViewWidget_2.setLabel('left', 'Signal', units='V')
        ...
        self._scanning_logic.signal_scan_range_updated.connect(self.update_scan_range_inputs)
        ...
        self._mw.xy_cb_ViewWidget.setLabel('left', 'Signal', units='V')
        ...
        self._mw.depth_cb_ViewWidget.setLabel('left', 'Signal', units='V')
...
#        self._mw.actionRotated_depth_scan.setEnabled(True)
    ...
    def save_xy_scan_data(self):
        ...
        filepath = self._save_logic.get_path_for_module(module_name='af_confocal')
    ...
    def save_configuration(self):
        ...
        defaultconfigpath = self._save_logic.get_path_for_module(module_name='af_confocal_cfg')
