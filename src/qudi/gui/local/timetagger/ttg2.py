...
class TTGui(GUIBase):
    ...
    sigDumpdata = QtCore.Signal(QCheckBox, str)
    ...
    def on_activate(self):
        ...
        self.sigDumpdata.connect(self._timetaggerlogic.dumpData)
        self.currentChan = 1
        self.binWidth = 100
        self.numBins = 1000
        self.refreshTime = 1
    ...
    def dumpData(self):
        self.sigDumpdata.emit(self._mw.saveDumpCheckBox, self._mw.dump_name_TextField.text())
